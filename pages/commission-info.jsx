    ...
    return (
        <>
            <GridRegular
                ...
                rootClass={"container mx-auto lg:flex justify-center gap-16 bg-card backdrop-blur-2xl rounded-xl shadow-2xl px-12 sm:py-24 pt-44 sm:pt-24 sm:mt-24 max-w-4xl shadow-2xl mx-auto mb-16  "}
            />
