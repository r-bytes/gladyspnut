...
const DrawChallenge = forwardRef((props, ref) => {
    ...
    return (
        <div className="h-screen flex items-center justify-center text-center" ref={ref}>
            {play ? (
                <div className="grid gap-6 place-content-center content-between bg-secondary px-44 py-16 rounded shadow-2xl backdrop-blur-xl max-w-4xl max-h-96 w-full h-full">
                    ...
                    <div className="align-self-end">
                        <Button className="text-secondary bg-button hover:bg-secondaryAccent px-16" onClick={() =>  shuffleImage()}> {!Image ? "Get Idea" : "Next Idea"} </Button>
                    </div>
                </div>
            ) : (
                <div className="grid gap-6 place-content-center content-between bg-secondary px-44 py-16 rounded shadow-2xl backdrop-blur-xl max-w-4xl max-h-96 w-full h-full">
                    <Button className="text-secondary text-2xl bg-button hover:bg-secondaryAccent p-12 mx-auto"
