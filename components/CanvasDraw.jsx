...
import CoordinateSystem, { IDENTITY } from "../utils/coordinateSystem";
import drawImage from "../utils/drawImage";
import { DefaultState } from "../utils/interactionStateMachine";
...
export default class CanvasDraw extends PureComponent {
  ...
  getSaveData = () => {
    ...
    shuffleImage = () => {
        this.setState({
            drawImage: drawData[this.randomNumber()]
        })
    }
  ...
  render() {
    return (
        <div className="h-screen flex flex-col item-center justify-end text-center">
        {console.log(this.state.drawImage)}

            <Button className="text-secondary bg-primaryAccent hover:bg-secondaryAccent px-4">
                Let play!
            </Button>

            <h1 className="text-3xl font-bold mb-4"> Draw: </h1>
            <span className="text-lg"> {this.state.drawImage} </span>
        
            <div className="mx-auto flex justify-center max-w-sm space-x-20 my-8 mb-10">
                <Button className="text-secondary bg-primaryAccent hover:bg-secondaryAccent px-4" onClick={() =>  this.shuffleImage()}> Get Image </Button>
            </div>
            <div
            ...
            <div className="mx-auto flex justify-center max-w-sm space-x-20 my-8 mb-24">
                <Button className="text-secondary bg-primaryAccent hover:bg-secondaryAccent px-4" onClick={() => (CanvasDraw.saveableCanvas.clear())}> Reset </Button>
                <Button className="text-secondary bg-primaryAccent hover:bg-secondaryAccent px-4" onClick={() =>  CanvasDraw.saveableCanvas.undo()}> Undo </Button>
            </div>
        </div>
    );
  }
