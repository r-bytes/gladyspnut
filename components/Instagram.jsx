...
const Instagram = () => {
    ...
    return (
        <div className="max-w-4xl md:w-5/6 mx-auto  bg-card rounded-xl my-32 backdrop-blur-3xl shadow-2xl px-12 grid place-items-center sm:place-items-start grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
