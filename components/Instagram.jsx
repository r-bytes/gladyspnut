...
const Instagram = () => {
    ...
    return (
        <div className="md:max-w-4xl lg:max-w-5xl xl:max-w-7xl max-w-7xl mx-4 lg:mx-auto bg-secondary rounded my-32 backdrop-blur-3xl shadow-2xl px-12 grid place-items-center sm:place-items-start grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
            <h1 className="col-span-full text-5xl font-bold mb-16 mt-16"> Instagram Feed </h1>
                {images?.map(i => (
                    <a className="mx-auto hover:scale-105" key={i.id} href={i.permalink} target="_blank" rel="noReferrer">
                ...
                <div className="col-span-full my-12 mb-24 mx-auto">
                    <a href={`https://www.instagram.com/gladyspnut`} target="_blank" rel="noReferrer">
                        <button
