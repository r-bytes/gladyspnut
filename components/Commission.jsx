    ...
    return (
        <div className={rootClass}>
            {selectedImages.map(img => (
                <div className="max-w-5/6 flex flex-col sm:flex-row justify-center items-center gap-20 bg-card mt-12 backdrop-blur-2xl rounded-xl shadow-2xl p-10" key={img.id}>
                {/* !carousel */}
                    <span className="">
                        <Image src={img.imageUrl} className="w-full object-fit h-64 rounded-lg" width={350} height={350} alt="#" />
                    </span>
                ...
                {/* carousel */}
                <div className="w-full flex flex-col flex-shrink-0 left-0 right-0 sm:flex-row items-center gap-20 bg-card mb-24 backdrop-blur-2xl rounded-xl shadow-2xl p-10">
