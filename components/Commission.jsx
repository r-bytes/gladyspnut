...
const Commission = () => {
    ...
    return (
        <div className="mx-auto w-2/3 flex flex-col gap-16">
            {selectedImages.map(img => (
                <div className="w-full flex-shrink-0 left-0 right-0 flex items-center gap-20" key={img.id}>
                    <span className="">
            ...
            {selectedCarouselImages.length ? selectedCarouselImages.map(imgs => (
                <div className="w-full flex-shrink-0 left-0 right-0 flex items-center gap-20" key={imgs.id}>
                ...
                <div className="w-full flex-shrink-0 left-0 right-0 flex items-center gap-20">
                    <span className="">
